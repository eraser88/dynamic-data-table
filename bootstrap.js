...
function setPaginationOptions(paginationOptions) {
    if (typeof paginationOptions.showTotalRecordCount == "undefined" || paginationOptions.showTotalRecordCount == "true") {
        paginationOptions["sInfo"]="Showing _START_ to _END_ of _TOTAL_ entries";
    }
    else {
        paginationOptions["sInfo"]="Showing _START_ to _END_ entries";
    }

    $.extend($.fn.dataTableExt.oPagination, {
        "bootstrap": {
            "fnInit": function (oSettings, nPaging, fnDraw) {
                if (typeof paginationOptions.showPageNavigationButtons == "undefined" || paginationOptions.showPageNavigationButtons == "true") {
            ...
            "fnUpdate": function (oSettings, fnDraw) {
                ...
                for (i = 0, iLen = an.length; i < iLen; i++) {
                    ...
                    if (typeof paginationOptions.directPageNumberAccess == "undefined" || paginationOptions.directPageNumberAccess == "true") {
