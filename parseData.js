var xmlUrl, columnData, defaultHtml, defaultColumnData, baseUrl, defaultUrl, htmlHeader, htmlFooter, columnHtml, paginationOptions;
var hideList = [];
var showList = [];
...
function getXmlAndSetTable(tableId, url) {
    ...
    complete = function () {
        columnHtml = columnHtml + htmlFooter;
...
function setColumnAndHtmlData(url, tableId) {
    ...
    baseUrl = "";
    defaultUrl = baseUrl;
    htmlHeader = "<table cellpadding='0' cellspacing='0' border='0' class='table table-bordered' id='dataTable' " +
        "width='100%'><tbody><thead><tr><th><input type='checkbox' id='globalCheckbox' name='globalCheckbox' /></th>";
    htmlFooter = "</tr></thead></tbody></table>";
    columnHtml = htmlHeader;
